...
PRODUCT_COPY_FILES += \
    vendor/addons/prebuilt/system_ext/etc/permissions/privapp-permissions-velvet.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-velvet.xml
