...
private fun Context.fontFamilyFromConfig(normalKey: String, mediumKey: String): FontFamily {
    ...
    if (normal.isEmpty() || medium.isEmpty()) return FontFamily.Default
    return FontFamily(
...
private fun buildExpressiveTypography(context: Context): Typography {
    ...
    return Typography(
        ...
        displayLargeEmphasized = TextStyle(
            fontFamily = variableFont("variable-display-large-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 57.sp, lineHeight = 64.sp, letterSpacing = (-0.2).sp, hyphens = Hyphens.Auto,
        ),
        ...
        displayMediumEmphasized = TextStyle(
            fontFamily = variableFont("variable-display-medium-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 45.sp, lineHeight = 52.sp, letterSpacing = 0.0.sp, hyphens = Hyphens.Auto,
        ),
        ...
        displaySmallEmphasized = TextStyle(
            fontFamily = variableFont("variable-display-small-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 36.sp, lineHeight = 44.sp, letterSpacing = 0.0.sp, hyphens = Hyphens.Auto,
        ),
        ...
        headlineLargeEmphasized = TextStyle(
            fontFamily = variableFont("variable-headline-large-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 32.sp, lineHeight = 40.sp, letterSpacing = 0.0.sp, hyphens = Hyphens.Auto,
        ),
        ...
        headlineMediumEmphasized = TextStyle(
            fontFamily = variableFont("variable-headline-medium-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 28.sp, lineHeight = 36.sp, letterSpacing = 0.0.sp, hyphens = Hyphens.Auto,
        ),
        ...
        headlineSmallEmphasized = TextStyle(
            fontFamily = variableFont("variable-headline-small-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 24.sp, lineHeight = 32.sp, letterSpacing = 0.0.sp, hyphens = Hyphens.Auto,
        ),
        ...
        titleLargeEmphasized = TextStyle(
            fontFamily = variableFont("variable-title-large-emphasized"), fontWeight = FontWeight.SemiBold,
        ...
        titleMediumEmphasized = TextStyle(
            fontFamily = variableFont("variable-title-medium-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 16.sp, lineHeight = 24.sp, letterSpacing = 0.02.em, hyphens = Hyphens.Auto,
        ),
        ...
        titleSmallEmphasized = TextStyle(
            fontFamily = variableFont("variable-title-small-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 14.sp, lineHeight = 20.sp, letterSpacing = 0.02.em, hyphens = Hyphens.Auto,
        ),
        bodyLarge = TextStyle(
        ...
        bodyLargeEmphasized = TextStyle(
            fontFamily = variableFont("variable-body-large-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 16.sp, lineHeight = 24.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
        ...
        bodyMediumEmphasized = TextStyle(
            fontFamily = variableFont("variable-body-medium-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 14.sp, lineHeight = 20.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
        bodySmall = TextStyle(
            fontFamily = plain, fontWeight = FontWeight.Normal,
        ...
        bodySmallEmphasized = TextStyle(
            fontFamily = variableFont("variable-body-small-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 12.sp, lineHeight = 16.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
        ...
        labelLargeEmphasized = TextStyle(
            fontFamily = variableFont("variable-label-large-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 14.sp, lineHeight = 20.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
        ...
        labelMediumEmphasized = TextStyle(
            fontFamily = variableFont("variable-label-medium-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 12.sp, lineHeight = 16.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
        ...
        labelSmallEmphasized = TextStyle(
            fontFamily = variableFont("variable-label-small-emphasized"), fontWeight = FontWeight.SemiBold,
            fontSize = 11.sp, lineHeight = 16.sp, letterSpacing = 0.01.em, hyphens = Hyphens.Auto,
        ),
    )
}
...
@Composable
internal fun rememberAxionTypography(): Typography {
